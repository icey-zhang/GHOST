...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='models/SRyolo_noFocus.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--ch', type=int,default=3, help = '3 4 16 midfusion1:64 midfusion2,3:128 midfusion4:256') 
