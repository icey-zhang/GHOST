...
def main():
    # detpath = 'runs/test/exp14/labels/Task2_{:s}.txt'
    # annopath = '/home/data4/zjq/DOTA-v1.0_split/val/labelTxt/{:s}.txt'#/home/data4/zjq/DOTA-v1.0/val/labelTxt-v1.0/Val_Task2_gt/valset_reclabelTxt
    # imagesetfile = '/home/data4/zjq/DOTA-v1.0_split/val1.txt'
    detpath = 'runs/test/exp14_dota_val/labels_merge/Task2_{:s}.txt'
    annopath = '/home/data4/zjq/DOTA-v1.0/val/labelTxt-v1.0/Val_Task2_gt/valset_reclabelTxt/{:s}.txt'#/home/data4/zjq/DOTA-v1.0/val/labelTxt-v1.0/Val_Task2_gt/valset_reclabelTxt
    imagesetfile = '/home/data4/zjq/DOTA-v1.0/val.txt'
