...
from .dota_utils import GetFileFromThisRootDir,parse_dota_poly2,custombasename,parse_dota_poly,dots4ToRecC,parse_longsideformat,classnames_v1_5
import os
import numpy as np
    ...
    for fullname in filelist:  # fullname='/.../P000?.txt'
        ...
        with open(os.path.join(dstpath, name + '.txt'), 'w') as f_out:
            for obj in objects:
                ...
                bbox = np.array(dots4ToRecC(poly, img_w, img_h))  # bbox=[x y w h]
